# Aleksandar Todorović (Personal Blog)

This is the code behind my personal blog hosted on GitHub Pages using Jekyll as a platform. 
...
This blog was previously hosted [here](https://aleksandartodorovic.wordpress.com/). If you're wondering how and why have I decided to do the transition, you can read about that [here](http://r3bl.github.io/en/why-switching-to-github-and-jekyll/). If you're wondering why I love GitHub so much, I suggest you to read [this article](http://r3bl.github.io/en/why-github-is-my-favorite-company/) (which I also posted [on Medium](https://medium.com/@r3bl/reasons-why-github-is-my-favorite-technology-related-company-5288d3ac45ad)).
...
For any other kind of feedback, feel free to contact me anytime on [aleksandar.todorovic@mail.ru](aleksandar.todorovic@mail.ru). If you care about privacy while sending an email, here is my public PGP key:
...
* Pictures I'm currently using are the theme's default ones (all of the credits for them goes to [dargadgets](http://www.dargadgetz.com/ios-8-abstract-wallpaper-pack-for-iphone-5s-5c-and-ipod-touch-retina/)). I'm planning on replacing them with my own selection in the near future.
...
As you can see, in the spirit of open source, this blog is built almost entirely upon open source projects.
